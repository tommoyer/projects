...
def location():
    ...
    '''
    print(f'Called resources location for {state["project"]}')
...
def browse():
    ...
    '''
    print(f'Called resources browse for {state["project"]}')
...
def terminal():
    ...
    '''
    print(f'Called resources terminal for {state["project"]}')
